...
{
    private Geldwert _ausgewaehlterGesamtbetrag;
    ...
    {
        _ausgewaehlterGesamtbetrag = new Geldwert(0);
        if (istVerkaufenMoeglich(plaetze))
        {
            Geldwert preis = _vorstellung.getPreisFuerPlaetze(plaetze);
            _ui.getPreisLabel().setText(
                    "Gesamtpreis: "+preis.getString()+" €");
